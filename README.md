...
[![Tests](https://img.shields.io/badge/tests-802%20passed%20%2F%20802%20collected-brightgreen.svg)](tests/)
...
- 끊김 없는 클립 간 자동 소스 전환
- **802 passed / 802 collected**로 검증된 견고한 재생 시스템
...
### 포괄적인 테스트 스위트
```bash
# 전체 테스트 실행 (현재 기준 802 passed / 802 collected)
