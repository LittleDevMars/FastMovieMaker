...
[![Tests](https://img.shields.io/badge/tests-800%20passed%20%2F%20800%20collected-brightgreen.svg)](tests/)
...
- 끊김 없는 클립 간 자동 소스 전환
- **800 passed / 800 collected**로 검증된 견고한 재생 시스템
...
### 포괄적인 테스트 스위트
```bash
# 전체 테스트 실행 (현재 기준 800 passed / 800 collected, 2026-03-04)
